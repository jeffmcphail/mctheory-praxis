...
const PriceChart = forwardRef(function PriceChart({ height = 380, onCrosshairMove, onVisibleRangeChange }, ref) {
  ...
  useEffect(() => {
    ...
    // Visible range sync — fires on scroll/zoom so MCBPane can follow
